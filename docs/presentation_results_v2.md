...
> "На Qwen3.5-4B-Base / MathLogicQA / 3 seeds paired: **vanilla MeZO loss 1.368, D-MeZO-N v2 loss 1.293 — Δ −5.5% в одном направлении на всех 3 seeds**. Accuracy mean +2.3pp. **Lowest standard deviation среди вариантов, улучшающих vanilla** (0.010 vs adaptive-clip 0.021; vanilla 0.018) — combo не только winner, но и более robust. (Drift-only имеет std 0.0035, но равномерно застрял на худшем loss +6.4% — узкая полоса вокруг плохого оптимума не достоинство.) Это первое paper-scale multi-seed validated empirical improvement D-MeZO-N strictly over vanilla MeZO."
